...
forceClose:1,width:350,height:200,fixedWidth:0,minScrollTop:0,onOk:null,onCancel:null,onClose:null,textOk:"\u786e\u5b9a",textCancel:"\u53d6\u6d88",closeImg:true,resetTime:100,resizable:1,styleDialog:{},styleTitle:{},styleContent:{},styleBtn:{},styleOk:{},styleCancel:{},styleOverlay:{opacity:0.3},valign:""},init:function(){this.config.htmlImgLoading='<img src="'+this.config.base+"/"+this.config.imgLoading+'"/>';var a="div.hudong_dialog {border:1px rgb(0, 126, 115) solid;background-color:#FFFFFF;overflow:hidden;}\t\t\t\n div.hudong_dialog h2.title{margin:0;height:22px;background-color:rgb(0, 126, 115);"+
"\t\t\t\tborder-bottom:1px solid rgb(0, 126, 115);color:#fff;padding:3px 5px;font-weight:bold;font-size:14px;overflow:hidden;-moz-user-select:none;line-height:22px;}\t\t\t\n div.hudong_dialog .close{display:block;float:right;cursor:pointer;width:16px;height:16px;margin:0;\t\t\t\ttop:5px;right:5px;position:absolute;background:url("+this.config.base+"/"+this.config.imgClose+");}\t\t\t\n div.hudong_dialog div.content{padding:0;text-align:center;background-color:#FFFFFF;position:relative;}\t\t\t\n div.hudong_dialog div.button{position:absolute;width:100%;left:0px;bottom:0;text-align:center;height:25px;padding:4px 10px 10px;}\t\t\t\n div.hudong_dialog div.button input{text-align:center;margin-right:10px;}\t\t\t\n div.hudong_overlay{z-index:2001;cursor:default;background-color:#ffffff;\t\t\t\twidth:0 !important;height:100%;top:0px;left:0 !important;position:absolute;margin:0 auto;}";
